...
const userMail = 'senslivedashboard@gmail.com'
const userPass = 'sxqgrjwwvzfvyztg'
...
module.exports.signuptwo = async(req, res) => {
    ...
    let select_query = `c`                 // AND query required with email
...
module.exports.tableData = (req, res) => {
    ...
    let select_query = `SELECT * FROM main_database WHERE device_uid = '${m_id}' ORDER BY id ASC LIMIT 30`
...
module.exports.sortMonth2 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvah FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT kvah FROM main_database WHERE device_uid ='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVAh_D FROM main_database LIMIT 1`;  //let select_query=`SELECT((SELECT KVAh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT KVAh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVAh_D FROM em6400ng LIMIT 1`;
...
module.exports.sortMonth3 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVARh_D FROM main_database LIMIT 1`;  //let select_query=`SELECT((SELECT KVARh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT KVARh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVARh_D FROM em6400ng LIMIT 1`;
...
module.exports.sortMonth4 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVARh_R FROM main_database LIMIT 1`;  //let select_query=`SELECT((SELECT KVARh_R FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id DESC LIMIT 1)-(SELECT KVARh_R FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month) ORDER by id ASC LIMIT 1))AS KVARh_R FROM em6400ng LIMIT 1`;
...
module.exports.sortWeek2 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvah FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id DESC LIMIT 1)-(SELECT kvah FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id ASC LIMIT 1))AS KVAh_D FROM main_database LIMIT 1`;  //let select_query=`SELECT((SELECT KVAh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id DESC LIMIT 1)-(SELECT KVAh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id ASC LIMIT 1))AS KVAh_D FROM em6400ng LIMIT 1`;
...
module.exports.sortWeek3 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id DESC LIMIT 1)-(SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id ASC LIMIT 1))AS kvarh FROM main_database LIMIT 1`;  //let select_query=`SELECT((SELECT KVARh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id DESC LIMIT 1)-(SELECT KVARh_D FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id ASC LIMIT 1))AS KVARh_D FROM em6400ng LIMIT 1`;
...
module.exports.sortWeek4 = (req, res) => {
    ...
    let select_query=`SELECT((SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id DESC LIMIT 1)-(SELECT kvarh FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 7 day) ORDER by id ASC LIMIT 1))AS KVARh_R FROM main_database LIMIT 1`;
...
module.exports.timeStampSort_Day = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 day)`;    //let select_query=`SELECT * FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 day)`;
...
module.exports.timeStampSort_Hour = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 hour)`;   //let select_query=`SELECT * FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 hour)`;
...
module.exports.timeStampSort_Live = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time = CURRENT_TIMESTAMP`;       //let select_query=`SELECT * FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time = CURRENT_TIMESTAMP`;
...
module.exports.timeStampSort_Minute = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 minute)`;
...
module.exports.timeStampSort_Month = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month)`;      //let select_query=`SELECT * FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 month)`;
...
module.exports.timeStampSort_Week = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid='${m_id}' AND date_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 week)`;   //let select_query=`SELECT * FROM em6400ng WHERE Device_Id='${m_id}' AND reading_time >= DATE_SUB(CURRENT_TIMESTAMP, interval 1 week)`;
...
module.exports.uniqueMeterName = (req, res) => {
    ...
    let select_query=`SELECT * FROM meterregistration WHERE meterName = '${meter_name}'`;
...
//
   ...
   // let select_query=`SELECT date_time, kwh, kvarh,KW,KVAR,KVA,PF from main_database where device_uid='${m_id}' AND date_time > now() - INTERVAL 8 day GROUP BY day(date_time) order by id ASC`;          //let select_query=`SELECT reading_time, KWh_D, KVARh_D,KVARh_R, KVAh_D,V_LL,V_LN,Aavg,KW,KVAR,KVA,PF from em6400ng where Device_Id='${m_id}' AND reading_time > now() - INTERVAL 8 day GROUP BY day(reading_time) order by id ASC`;
...
//     let select_query=`SELECT date_time, KWh, kvarh, KVAh,Aavg,KW,KVAR,KVA,PF from em6400ng where Device_Id='${m_id}' AND reading_time>now() - INTERVAL 1 day GROUP BY hour(reading_time) order by id ASC`;
...
module.exports.meter_CardData = (req, res) => {
    ...
    let select_query=`SELECT * FROM main_database WHERE device_uid = (SELECT meterid FROM meterregistration WHERE meterid='${value}' limit 1) ORDER BY id DESC LIMIT 1`;
...
module.exports.bar_graph= (req ,res )=>{
    ...
    let select_query=`select id , date_time , kwh , imp_kvarh , kvah  from date_time WHERE device_uid=${JSON.stringify(req.query.d_id)} AND date_time <= ${JSON.stringify(req.query.date)} group by ${frame}(date_time) order by id desc limit ${limit}`;
    //console.log(select_query);
    ...
    if (req.params.m_id  == 'line'){
        ...
        // const backdate = new Date(now.setDate(now.getDate() - parseInt(limit)));
        ...
        select_query=`select id , date_time , kw , kvar , kva  from main_database WHERE device_uid=${JSON.stringify(req.query.d_id)} AND date_time <= ${JSON.stringify(req.query.date)} group by ${frame}(date_time) order by id desc limit ${limit}`;
    }
